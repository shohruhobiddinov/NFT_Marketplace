...
import {monthTable, todayTable} from "../../data/backend";

function Thismonth(props) {
    return (
        <div className={"px-[10%] py-10"}>
            <div
                className={"border-[#3B3B3B] text-[#858584] border-2 rounded-3xl my-5 p-3 w-full flex justify-start items-center gap-3 "}>
                    <span
